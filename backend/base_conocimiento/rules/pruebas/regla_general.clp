(defrule recomendar_museo
    ...
    (test (or (member$ ?categoria_especificada ?categoria) (eq ?categoria_especificada No_relevante)))
    (test (or (member$ ?dia_especificado ?dia_atencion) (eq ?dia_especificado No_relevante)))
    (test (or (and (>= ?hora_especificada ?ha_inicio) (<= ?hora_especificada ?ha_fin)) (eq ?hora_especificada No_relevante)))
    (test (or (and (eq ?concurrencia_usuario Relevante) (not (member$ ?dia_especificado ?dia_concurrido)) (or (< ?hora_especificada ?hc_inicio) (> ?hora_especificada ?hc_fin))) 
...
; REGLA GENERAL - PRUEBA 1
(defrule regla_general_prueba1
    (preferencias_usuario 
        (distrito_especificado ?distrito_especificado)
        (dia_especificado ?dia_especificado)
        (hora_especificada ?hora_especificada)
